...
// POST /friends/requests gọi markFriendRequestSent (side-effect ghi DB) sau khi
// sendFriendRequest — phải stub, nếu không real handler chạm prisma → throw → 500.
...
describe('Friend Queries', () => {
  ...
  it('GET /friends/aliases — returns alias list', async () => {
    ...
    // Route truyền pagination mặc định: getAliasList(accountId, count=100, page=1)
